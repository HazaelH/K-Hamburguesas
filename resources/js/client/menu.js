...
// Nota: Las funciones window.cargarCategoria, abrirModal y confirmarAgregar 
// en este archivo parece que pertenecen a una versión antigua o a un panel distinto,
// porque la vista menu.blade.php usa menu-interaction.js. 
// Si este archivo no se usa en el front del cliente, lo dejamos así para no romper nada.
    ...
    fetch(`/api/producto/${id}`)
        ...
        .then(prod => {
            ...
            if (prod.opciones && Object.keys(prod.opciones).length > 0) {
                ...
                container.innerHTML = '<p class="text-gray-500 italic text-center py-4">No config needed.</p>';
            }
