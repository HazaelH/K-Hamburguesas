...
@section('titulo', __('admin/products/products.title_create'))
...
<div class="max-w-6xl mx-auto py-8">
    ...
    <div class="flex justify-between items-center mb-8">
        <h1 class="text-3xl font-bold text-white">
            <i class="fas fa-plus-circle text-orange-500 mr-2"></i> {{ __('admin/products/products.title_create') }}
        </h1>
        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-8 xl:gap-12">
                ...
                <div class="space-y-6">
                    ...
                    {{-- BLOQUE: TEXTOS EN ESPAÑOL (OBLIGATORIOS) --}}
                    <div class="bg-gray-900/50 p-5 rounded-xl border border-gray-700 shadow-inner">
                        ...
                        <div class="space-y-4">
                            <div>
                                <label class="block text-sm font-bold text-gray-300 mb-2">{{ __('admin/products/products.label_name') }} <span class="text-orange-500">*</span></label>
                                <input type="text" name="nombre" value="{{ old('nombre') }}" required placeholder="{{ __('admin/products/products.ph_name') }}"
                            ...
                            <div>
                                ...
                                <textarea name="descripcion" rows="3" placeholder="{{ __('admin/products/products.ph_desc') }}"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-bold text-gray-300 mb-2">{{ __('admin/products/products.label_price') }} <span class="text-orange-500">*</span></label>
                            <div class="relative">
                                <span class="absolute left-3 top-3 text-gray-500 font-bold">MX$</span>
                                <input type="number" id="precio_base" name="precio" step="0.50" value="{{ old('precio') }}" required placeholder="0.00"
                                       class="w-full bg-gray-900 text-white border border-gray-600 rounded-lg p-3 pl-12 focus:outline-none focus:border-orange-500 transition font-mono">
                            </div>
                        ...
                        <div>
                            <label class="block text-sm font-bold text-gray-300 mb-2">{{ __('admin/products/products.label_category') }} <span class="text-orange-500">*</span></label>
                            
                            @php
                                $categoriasBd = \App\Models\Categoria::all();
                            @endphp
                            
                            <select name="categoria" required class="w-full bg-gray-900 text-white border border-gray-600 rounded-lg p-3 focus:outline-none focus:border-orange-500 transition appearance-none cursor-pointer">
                                <option value="" disabled selected>{{ __('admin/products/products.ph_category') }}</option>
                    ...
                    <div class="flex flex-col">
                        <label class="block text-sm font-bold text-gray-300 mb-2">{{ __('admin/products/products.label_photo') }}</label>
                        <div class="bg-gray-900 border-2 border-dashed border-gray-600 rounded-xl flex items-center justify-center relative overflow-hidden group hover:border-orange-500 transition h-72 shadow-inner" id="image-preview-container">
                            <div class="text-center p-6 transition transform group-hover:scale-105" id="placeholder-text">
                                <i class="fas fa-cloud-upload-alt text-5xl text-gray-500 mb-3"></i>
                                <p class="text-gray-300 font-bold">{{ __('admin/products/products.upload_click') }}</p>
                                <p class="text-gray-500 text-xs mt-2">{{ __('admin/products/products.upload_formats') }}</p>
                            </div>
                            <img id="preview-img" src="#" alt="Vista previa" class="absolute inset-0 w-full h-full object-contain hidden bg-black/50 backdrop-blur-sm p-2">
                            <input type="file" name="imagen" id="imagen-input" accept="image/*" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer">
                        </div>
                    ...
                    <div class="bg-blue-900/10 p-5 rounded-xl border border-blue-900/30">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="nombre_en" value="{{ old('nombre_en') }}" placeholder="Ex: Double Monster Burger"
                            ...
                            <div>
                                ...
                                <textarea name="descripcion_en" rows="2" placeholder="Ingredients, details..."
                                          class="w-full bg-gray-900 text-white border border-gray-600 rounded-lg p-3 focus:outline-none focus:border-blue-500 transition">{{ old('descripcion_en') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-emerald-900/10 p-5 rounded-xl border border-emerald-900/30">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="nombre_pt" value="{{ old('nombre_pt') }}" placeholder="Ex: Hambúrguer Monstro"
                            ...
                            <div>
                                ...
                                <textarea name="descripcion_pt" rows="2" placeholder="Ingredientes, detalhes..."
                                          class="w-full bg-gray-900 text-white border border-gray-600 rounded-lg p-3 focus:outline-none focus:border-emerald-500 transition">{{ old('descripcion_pt') }}</textarea>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-gray-900/30 p-6 rounded-xl border border-gray-700 w-full mt-6">
                <label class="block text-lg font-bold text-white mb-4">
                    <i class="fas fa-list-ul text-orange-500 mr-2"></i> {{ __('admin/products/products.label_modifiers') }}
                </label>
                ...
                <div class="bg-gray-900 border border-gray-600 rounded-xl p-5 transition min-h-[50px]">
                    ...
                    {{-- Formulario para agregar un nuevo Extra (Ahora con 5 columnas anchas) --}}
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 items-start">
                        <div class="lg:col-span-1">
                            ...
                            <input type="text" id="tag-name" placeholder="Ej: Con limón" class="w-full bg-gray-800 text-white border border-gray-700 rounded-lg p-2.5 text-sm outline-none focus:border-orange-500 transition">
                        </div>
                        <div class="lg:col-span-1">
                        ...
                        <div class="lg:col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="tag-price" placeholder="0.00" min="0" step="0.50" class="w-full bg-gray-800 text-white border border-gray-700 rounded-lg p-2.5 pl-8 text-sm outline-none focus:border-orange-500 transition font-mono">
                            </div>
                        ...
                        <div class="lg:col-span-1 flex items-end h-full">
                            <button type="button" id="btn-add-tag" class="w-full bg-orange-600 hover:bg-orange-500 text-white px-4 py-2.5 rounded-lg text-sm font-bold transition-colors flex items-center justify-center gap-2 mt-auto">
                ...
                <input type="hidden" name="opciones_personalizacion" id="hidden-tags" value="{{ old('opciones_personalizacion', '[]') }}">
            ...
            <div class="border-t border-gray-700 pt-6 mt-6">
                <button type="submit" class="w-full bg-orange-600 hover:bg-orange-500 text-white font-black py-4 rounded-xl shadow-lg transform transition hover:scale-[1.01] text-lg">
        ...
        function addTag() {
            ...
            if (nombre) {
                ...
                if (!existe) {
                    ...
                    // Limpiamos las cajitas y ocultamos la conversión
                    tagName.value = ''; 
                    tagNameEn.value = ''; 
                    tagNamePt.value = ''; 
                    tagPrice.value = ''; 
