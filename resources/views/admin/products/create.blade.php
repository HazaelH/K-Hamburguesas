            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-8 xl:gap-12">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-900/50 p-5 rounded-xl border border-gray-300 shadow-inner">
                        ...
                        <div class="space-y-4">
                            <div>
                                <label for="nombre" class="block text-sm font-bold text-gray-300 mb-2">{{ __('admin/products/products.label_name') }} <span class="text-orange-500">*</span></label>
                                <input type="text" id="nombre" name="nombre" value="{{ old('nombre') }}" required placeholder="{{ __('admin/products/products.ph_name') }}"
                            ...
                            <div>
                                ...
                                <textarea id="descripcion" name="descripcion" rows="3" placeholder="{{ __('admin/products/products.ph_desc') }}"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label for="precio_base" class="block text-sm font-bold text-gray-300 mb-2">{{ __('admin/products/products.label_price') }} <span class="text-orange-500">*</span></label>
                            <div class="relative">
                        ...
                        <div>
                            <label for="categoria" class="block text-sm font-bold text-gray-300 mb-2">{{ __('admin/products/products.label_category') }} <span class="text-orange-500">*</span></label>
                            
                            @php
                                $categoriasBd = \App\Models\Categoria::all();
                            @endphp
                            
                            <select id="categoria" name="categoria" required class="w-full bg-gray-900 text-white border border-gray-600 rounded-lg p-3 focus:outline-none focus:border-orange-500 transition appearance-none cursor-pointer">
                    ...
                    <div class="flex flex-col">
                        <label for="imagen-input" class="block text-sm font-bold text-gray-300 mb-2">{{ __('admin/products/products.label_photo') }}</label>
                        <div class="bg-gray-900 border-2 border-dashed border-gray-600 rounded-xl flex items-center justify-center relative overflow-hidden group hover:border-orange-500 transition h-72 shadow-inner" id="image-preview-container">
                            ...
                            <img id="preview-img" src="#" alt="Vista previa del producto" class="absolute inset-0 w-full h-full object-contain hidden bg-black/50 backdrop-blur-sm p-2">
                    ...
                    <div class="bg-blue-900/10 p-5 rounded-xl border border-blue-900/30">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" id="nombre_en" name="nombre_en" value="{{ old('nombre_en') }}" placeholder="Ex: Double Monster Burger"
                    ...
                    <div class="bg-emerald-900/10 p-5 rounded-xl border border-emerald-900/30">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" id="nombre_pt" name="nombre_pt" value="{{ old('nombre_pt') }}" placeholder="Ex: Hambúrguer Monstro"
                ...
                <div class="bg-gray-900 border border-gray-600 rounded-xl p-5 transition min-h-[50px]">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 items-start">
                        <div class="lg:col-span-1">
                            ...
                            <input type="text" id="tag-name" placeholder="Ej: Con limón" class="w-full bg-gray-800 text-white border border-gray-300 rounded-lg p-2.5 text-sm outline-none focus:border-orange-500 transition">
                        </div>
                        <div class="lg:col-span-1">
                        ...
                        <div class="lg:col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="tag-price" placeholder="0.00" min="0" step="0.50" class="w-full bg-gray-800 text-white border border-gray-300 rounded-lg p-2.5 pl-8 text-sm outline-none focus:border-orange-500 transition font-mono">
                            </div>
                        ...
                        <div class="lg:col-span-1 flex items-end h-full">
                            <button type="button" id="btn-add-tag" class="w-full bg-orange-700 hover:bg-orange-500 text-white px-4 py-2.5 rounded-lg text-sm font-bold transition-colors flex items-center justify-center gap-2 mt-auto">
