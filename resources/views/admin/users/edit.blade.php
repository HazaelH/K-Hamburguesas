                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="password" name="password" id="edit-password" placeholder="{{ __('admin/users/users.placeholder_password_edit') }}"
                                    class="w-full bg-slate-900 text-white border border-slate-600 rounded-lg p-3 pl-10 pr-10 focus:outline-none focus:border-orange-500 transition">
                                <button type="button" onclick="togglePassword('edit-password', 'eye-edit')" class="absolute right-3 top-3 text-slate-500 hover:text-orange-500 transition-colors focus:outline-none">
                                    <i id="eye-edit" class="fas fa-eye"></i>
                                </button>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="password" name="password_confirmation" id="edit-password-confirm" placeholder="{{ __('admin/users/users.placeholder_password_confirm') }}"
                                    class="w-full bg-slate-900 text-white border border-slate-600 rounded-lg p-3 pl-10 pr-10 focus:outline-none focus:border-orange-500 transition">
                                <button type="button" onclick="togglePassword('edit-password-confirm', 'eye-edit-conf')" class="absolute right-3 top-3 text-slate-500 hover:text-orange-500 transition-colors focus:outline-none">
                                    <i id="eye-edit-conf" class="fas fa-eye"></i>
                                </button>
                            </div>
                        </div>
                    </div>
